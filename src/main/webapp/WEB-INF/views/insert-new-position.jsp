<div ng-app="x.beirut.position.option-angularApp" ng-controller="positionCreateNew.ctrl">
    ...
    <form>
        ...
        <input type="text"
               ...
               style="width:300px" ng-model="title" name="insertNewPosition" placeholder="Job Title"
               id="Job Title" required="">
        <br>
        <label> Job Type </label>
        <input type="text"
               class="form-control ng-pristine ng-invalid ng-invalid-required ng-touched"
               style="width:300px" ng-model="jobType" name="insertNewPosition"
               placeholder="Job Type" id="Job Type" required="">
        <br>
        <label> Job Division </label>
        <input type="text"
               class="form-control ng-pristine ng-invalid ng-invalid-required ng-touched"
               style="width:300px" ng-model="jobDivision" name="insertNewPosition"
               placeholder="Job Division" id="Job Division" required="">
        <br>
        ...
        <button type="submit" style="background-color:#086CA3" class="btn btn-success"
                ng-click="submitPosition('${applicationBasePathLocation}/view/jobs-management')">Submit
        </button>
    </form>
