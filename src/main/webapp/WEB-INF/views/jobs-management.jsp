            ...
            <div class="autocomplete " id="" style="height: 100%" data="test">
                ...
                <div class="col-sm-6">
                    <a style="color:white; text-decoration:none;"
                       href="/beirut-ui/view/insert-new-position">
                        <button type="button" class="btn btn-primary pull-right"
                                ng-click="popModal()">
                            <i class="bli bli-plus"></i> Tambah
                        </button>
                    </a>
                </div>
            </div>
    ...
    <div class="row">
        <table class="table table-striped" style="margin-top: 0;">
            ...
            <tr ng-repeat="position in positions" class="beirutRows">
                <td><input type="checkbox" ng-model="position.selected" value="{{position.id}}"
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right" role="menu">
                            <li>
                                <a href="${applicationBasePathLocation}/view/jobs-management-detail/{{position.id}}">View</a>
                            </li>
                            <li>
                                <a href="${applicationBasePathLocation}/view/position-edit/{{position.id}}">Ubah</a>
                            </li>
                        </ul>
                    </div>
                </td>
        ...
        <div class="panel-body col-md-12">
            ...
            <div class="col-md-6  col-sm-8">
                <div class="col-md-4 col-sm-4">
                    <select class="form-control" ng-model="selectedStatus" name="new-url"
                            id="new-url" tooltip="mandatory">
                        <option>OPEN</option>
                        <option>CLOSE</option>
